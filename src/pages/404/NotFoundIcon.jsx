  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600">
      ...
      >
        ...
        <circle id="craterBig" cx="548.891" cy="62.319" r="13.074"></circle>
        <circle id="craterSmall" cx="591.743" cy="158.918" r="7.989"></circle>
        <path
          id="ring"
          strokeLinecap="round"
      ...
      <g id="spaceman" clipPath="url(cordClip)">
        ...
        <g
          ...
          strokeWidth="3"
        >
          <path d="M360.633 363.039c1.352 1.061 4.91 5.056 5.824 6.634l27.874 47.634c3.855 6.649 1.59 15.164-5.059 19.02h0c-6.649 3.855-15.164 1.59-19.02-5.059l-5.603-9.663"></path>
          <path d="M388.762 434.677c5.234-3.039 7.731-8.966 6.678-14.594a15.804 15.804 0 015.837 5.793c4.411 7.596 1.829 17.33-5.767 21.741-7.596 4.411-17.33 1.829-21.741-5.767-1.754-3.021-2.817-5.818-2.484-9.046 4.34 4.551 11.802 5.169 17.477 1.873z"></path>
        </g>
        <g
          id="armL"
          fill="#FFF"
          ...
          strokeWidth="3"
        >
          <path d="M301.301 347.66c-1.702.242-5.91 1.627-7.492 2.536l-47.965 27.301c-6.664 3.829-8.963 12.335-5.134 18.999h0c3.829 6.664 12.335 8.963 18.999 5.134l9.685-5.564"></path>
          <path d="M241.978 395.324c-3.012-5.25-2.209-11.631 1.518-15.977a15.821 15.821 0 00-7.952 2.096c-7.619 4.371-10.253 14.09-5.883 21.71 4.371 7.619 14.09 10.253 21.709 5.883 3.03-1.738 5.35-3.628 6.676-6.59-6.033 1.768-12.803-1.429-16.068-7.122z"></path>
        </g>
        <g
          id="body"
          stroke="#0E0620"
